...
grafana:
  ...
  service:
    ...
    port: 3000
  plugins:
    - "https://github.com/cardinalhq/cardinalhq-lakerunner-datasource/releases/download/v1.2.0-rc.10/cardinalhq-lakerunner-datasource.zip;cardinalhq-lakerunner-datasource"
  datasources:
    datasources.yaml:
      apiVersion: 1
      datasources:
